---
name: commits
description: Analyze the git diff and propose how to group changes into separate commits using only whole-file git add commands. Commit messages must always be in English. Must not execute commands.
---
...
- Provide clear commit messages in English.
